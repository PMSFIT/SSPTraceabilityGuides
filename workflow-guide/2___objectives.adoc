...
LS SSP Traceability requires that the import and export tools as well as the data management systems support this standard and this structure. However, no specifications are provided regarding how the data management tool must internally structure the data.
