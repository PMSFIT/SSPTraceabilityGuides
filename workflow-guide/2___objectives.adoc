...
In the following it is described how the STMD Schema supports the Credible Simulation Process. (more information: https://modelica.github.io/ssp-ls-traceability/main/#sec-crediblesimulationprocessframework[Credible Simulation Process Framework] ).
The typical procedure in a development or simulation process is shown in Figure 1.
...
image::CSP-recursions.png[CSP-recursions, 1000, 1000]
...
LS SSP Traceability requires that the import and export tools as well as the data management systems support this standard and this structure. However, no specifications are provided regarding how the internal data management tool must be structured.
