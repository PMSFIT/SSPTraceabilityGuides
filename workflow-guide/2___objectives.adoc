...
In the following it is described how the STMD Schema supports the Credible Simulation Process. https://modelica.github.io/ssp-ls-traceability/main/#sec-crediblesimulationprocessframework[Credible Simulation Process Framework].
