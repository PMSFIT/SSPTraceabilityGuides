...
The listed process phase "Administrative" is not a phase itself but it is part of the STMD-File and contains the relevant administrative information. This set of metadata can be used as starting point in implementation.
